!(function(t, e, i) {
  !(function() {
            ...
            ? ((this.loc = e.fn.datepicker.language[t]),
              this.loc ||
                (console.warn(
                  "Can't find language \"" +
                    t +
                    '" in Datepicker.language, will use "es" instead'
                ),
    ...
    (function() {
      var t =
          '<div class="datepicker--time"><div class="datepicker--time-current">   <span class="datepicker--time-current-hours">#{hourVisible}</span>   <span class="datepicker--time-current-colon">:</span>   <span class="datepicker--time-current-minutes">#{minValue}</span></div><div class="datepicker--time-sliders">   <div class="datepicker--time-row">      <input type="range" name="hours" value="#{hourValue}" min="#{hourMin}" max="#{hourMax}" step="#{hourStep}" class="form-control"/>   </div>   <div class="datepicker--time-row">      <input type="range" name="minutes" value="#{minValue}" min="#{minMin}" max="#{minMax}" step="#{minStep}" class="form-control"/>   </div></div></div>',
        i = e.fn.datepicker,
        s = i.Constructor;

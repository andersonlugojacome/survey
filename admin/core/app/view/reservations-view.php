      ...
      <div class="card-content table-responsive">
        ...
        ?>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-2">
              <div class="input-group">
                <span class="input-group-addon"><i class="material-icons">person_add</i></span>
            ...
            echo "selected";
        } ?>><?php echo $p->id." - ".$p->name." ".$p->lastname; ?>
                  </option>
                  <?php endforeach; ?>
                </select>
              </div>
        ...
        <table class="table table-bordered table-hover">
          ...
          <tr>
            ...
            <td><?php echo $pacient->name." ".$pacient->lastname; ?>
            </td>
            <td><?php echo $medic->name." ".$medic->lastname; ?>
            </td>
            <td><?php echo $user->date_at." ".$user->time_at; ?>
            </td>

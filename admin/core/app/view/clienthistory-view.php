    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header" data-background-color="blue">
                <h4 class="title">
                    <i class='fa fa-clock-o'></i><?php echo $client->name." ".$client->lastname; ?>
                </h4>
            </div>
            <div class="card-content table-responsive">

                <form class="form-horizontal" role="form">
                    <input type="hidden" name="view" value="clienthistory" />
                        ...
                        <div class="col-lg-3">
                            <div class="input-group">
                                ...
                                <div class='input-group date' id='start_at_div'>
                                    ...
                                    <input type="text" name="start_at" id="start_at" class="form-control" required value="<?php if(isset($_GET["start_at"]) && $_GET["start_at"]!=""){ echo $_GET["start_at"]; } ?>" placeholder="Fecha inicio" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="input-group">
                                <label for="" class="bmd-label-floating">Fin</label>
                ...
                <table class="table table-bordered table-hover	">
                    <thead>
                        ...
                        <th>Fin</th>
                        <th>Regreso</th>
                    </thead><?php foreach($products as $sell):
                            $item = $sell->getItem();
                            $book = $item->getBook();
                    ?>
                    <tr>
                ...
                ?>
                <p class="alert alert-danger">No hay prestamos.</p><?php
                        }
                                                                   ?>
                <br />
            </div>
...
<!-- jQuery UI -->
<script type="text/javascript" src="/themes/TEP/js/jquery-ui.min.js"></script>
<script type="text/javascript" src='/themes/TEP/js/moment.min.js'></script>
<script type="text/javascript" src="/themes/TEP/js/es.js"></script>
<script type="text/javascript" src="/themes/TEP/js/bootstrap-datetimepicker.js"></script>

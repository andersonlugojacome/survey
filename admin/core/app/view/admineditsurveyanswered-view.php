...
$result = SurveylistsanswerData::getAllAnswersByPnSurveylistsID($pn, $pn_anho, $surveylists_id);
print_r($result);
...
<div class="row page-titles">
    <div class="col-md-12 col-12 align-self-center">
        <h3 class="text-themecolor mb-0">Linguistic survey</h3>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Linguistic survey</h4>
                    <h6 class="card-subtitle"></h6>

                    <form class="" method="post" id="updatesurveyanswer" action="./?action=updatesurveyanswer" role="form">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="pn" class="bmd-label-floating">Project number:</label>
                                    <input type="text" class="form-control" id="pn" name="pn" autocomplete="off" value="<?=$pn?>" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    ?>
                                        <tr data-background-color-approval="">
                                            <td>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <?php if (!empty($linkpdf)) : ?>
                                                                        <object width="100%" height="350px" data="<?php echo $linkpdf; ?>#zoom=85" type="application/pdf" trusted="yes" application="yes"></object>
                                                                    <?php endif ?>
                                                                </div>
                                                ...
                                                <input type="hidden" name="<?php echo "q_" . $surveylistsquestions_id; ?>" id="
                                <?php echo "q_" . $surveylistsquestions_id; ?>" value='
                                <?php echo $question1; ?>'>
                                            </td>
                                            <td>
                                                <?php

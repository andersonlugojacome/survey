...
{ 
    ...
    public function add()
    {
        $sql= "INSERT INTO ".self::$tablename." (pn,pn_anho, answer,surveylistsquestions_id, user_id, client_id, created_at, surveylists_id, a_code_approval)";
        $sql .= " VALUES (\"$this->pn\",\"$this->pn_anho\",\"$this->answer\",\"$this->surveylistsquestions_id\",\"$this->user_id\",\"$this->client_id\",\"$this->created_at\",\"$this->surveylists_id\" ,\"$this->a_code_approval\" )";
        //echo $sql;
        Executor::doit($sql);
    }
